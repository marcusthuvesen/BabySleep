...
//  Tinnitus
//
//  Created by Marcus Thuvesen on 2019-08-26.
...
extension UIView{
    struct CustomColors{
        ...
        static var transparentPink = UIColor(red: 243.0/255, green: 83.0/255, blue: 213.0/255, alpha: 1)
        ...
        static var gold = UIColor(red: 248.0/255, green: 196.0/255, blue: 51.0/255, alpha: 1.0)
